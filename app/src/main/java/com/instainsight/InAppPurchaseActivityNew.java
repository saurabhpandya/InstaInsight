 ...
 */
public class InAppPurchaseActivityNew extends Activity implements IabBroadcastReceiver.IabBroadcastListener,
    ...
    static final String SKU_REMOVE_ADS_MONTHLY = "remove_ads_1_month_subscription";
    static final String SKU_REMOVE_ADS_YEARLY = "infinite_gas_yearly";
    ...
    IabHelper.QueryInventoryFinishedListener mGotInventoryListener = new IabHelper.QueryInventoryFinishedListener() {
        public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
            ...
            Purchase gasYearly = inventory.getPurchase(SKU_REMOVE_ADS_YEARLY);
            if (gasMonthly != null && gasMonthly.isAutoRenewing()) {
                mInfiniteGasSku = SKU_REMOVE_ADS_MONTHLY;
                mAutoRenewEnabled = true;
            } else if (gasYearly != null && gasYearly.isAutoRenewing()) {
                mInfiniteGasSku = SKU_REMOVE_ADS_YEARLY;
                mAutoRenewEnabled = true;
            } else {
                mInfiniteGasSku = "";
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
            ...
            if (purchase.getSku().equals(SKU_GAS)) {
                ...
                updateUi();
                setWaitScreen(false);
            } else if (purchase.getSku().equals(SKU_REMOVE_ADS_MONTHLY)
                    || purchase.getSku().equals(SKU_REMOVE_ADS_YEARLY
            )) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            public void onIabSetupFinished(IabResult result) {
                ...
                mBroadcastReceiver = new IabBroadcastReceiver(InAppPurchaseActivityNew.this);

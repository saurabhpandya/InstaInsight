...
public class USERS_FOLLOWEDBY {
    public static String TABLE_NAME = "USERS_FOLLOWEDBY";
    private static final String USERS_FOLLOWEDBY_TBL_DROP = "DROP TABLE IF EXISTS " + TABLE_NAME;
    ...
    private static final String USERS_FOLLOWEDBY_TBL_CREATE = (new StringBuffer())
    ...
    public static String createTable() {
        ...
        return USERS_FOLLOWEDBY_TBL_CREATE;
    }

    public static String dropTable() {
        return USERS_FOLLOWEDBY_TBL_DROP;
    }
}

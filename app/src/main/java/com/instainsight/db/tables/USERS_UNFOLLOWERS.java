...
public class USERS_UNFOLLOWERS {
    public static String TABLE_NAME = "USERS_UNFOLLOWERS";
    private static final String USERS_UNFOLLOWERS_TBL_DROP = "DROP TABLE IF EXISTS " + TABLE_NAME;
    ...
    private static final String USERS_UNFOLLOWERS_TBL_CREATE = (new StringBuffer())
    ...
    public static String createTable() {
        ...
        return USERS_UNFOLLOWERS_TBL_CREATE;
    }

    public static String dropTable() {
        return USERS_UNFOLLOWERS_TBL_DROP;
    }
}

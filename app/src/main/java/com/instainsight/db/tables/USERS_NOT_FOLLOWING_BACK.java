...
public class USERS_NOT_FOLLOWING_BACK {
    public static String TABLE_NAME = "USERS_NOT_FOLLOWING_BACK";
    private static final String USERS_NOT_FOLLOWING_BACK_TBL_DROP = "DROP TABLE IF EXISTS " + TABLE_NAME;
    ...
    private static final String USERS_NOT_FOLLOWING_BACK_TBL_CREATE = (new StringBuffer())
    ...
    public static String createTable() {
        ...
        return USERS_NOT_FOLLOWING_BACK_TBL_CREATE;
    }

    public static String dropTable() {
        return USERS_NOT_FOLLOWING_BACK_TBL_DROP;
    }
}

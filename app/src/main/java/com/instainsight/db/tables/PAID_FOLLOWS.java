...
public class PAID_FOLLOWS {
    public static String TABLE_NAME = "PAID_FOLLOWS";
    private static final String PAID_FOLLOWS_TBL_DROP = "DROP TABLE IF EXISTS " + TABLE_NAME;
    ...
    private static final String PAID_FOLLOWS_TBL_CREATE = (new StringBuffer())
            ...
            .append(");").toString();
    private static String TAG = PAID_FOLLOWS.class.getSimpleName();

    public static String createTable() {
        Log.d(TAG, TABLE_NAME + " TABLE CREATED");
        return PAID_FOLLOWS_TBL_CREATE;
    }

    public static String dropTable() {
        return PAID_FOLLOWS_TBL_DROP;
    }
}

...
public class FollowersAdap extends RecyclerView.Adapter<FollowersAdap.MyViewHolder> {

    private List<FollowerBean> followedByList;
    private Context mContext;
    private RelationshipStatusChangeListner relationshipStatusChangeListner;

    public FollowersAdap(Context context, List<FollowerBean> followedByList,
    ...
    public void addFollowersing(ArrayList<FollowerBean> followedByList) {
        this.followedByList = new ArrayList<>();
        this.followedByList.addAll(followedByList);
    }

    public void removeFollowersing(int position) {
        this.followedByList.remove(position);
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final FollowerBean followerBean = followedByList.get(position);
        ...
        if (followerBean.getRelationShipStatus() != null) {
            ...
            holder.txtvw_followersing.setVisibility(View.INVISIBLE);
        }

...
public class UnFollowersAdap extends RecyclerView.Adapter<UnFollowersAdap.MyViewHolder> {

    private List<FollowerBean> unFollowersList;
    private Context mContext;
    private RelationshipStatusChangeListner relationshipStatusChangeListner;

    public UnFollowersAdap(Context context, List<FollowerBean> unFollowersList,

package com.instainsight.instagram.util;
 ...
 */
public class Cons {
    public static final String TAG = "InstaInsight";
    ...
    public static final String DAGGER_API_BASE_URL = "https://api.instagram.com/v1/";
